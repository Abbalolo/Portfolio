...
function Services() {
  ...
  return (
    <section className="text-center mx-5 dark:bg-[#121212] dark:text-white lg:mx-16 md:mx-10  ">
      <div className="">
        <h2 data-aos="fade-left" className="py-1 font-extrabold text-2xl text-center md:text-4xl md:text-start text-blue-700 dark:text-blue-700 ">
          What I Do
        </h2>
        <p data-aos="fade-right" className=" text-gray-800 dark:text-gray-400 text-md leading-8 text-start">
        ...
        <div className="mt-10 md:grid md:grid-cols-2 place-items-center mb-20">
          {cards.map((icon, index) => {
            return (
              <div
                className="flex flex-col mx-auto items-center  hover:shadow-xl p-3 dark:hover:bg-[#161616] rounded-md duration-500  md:overflow-visible md:w-96 md:grid "
                key={index}
              >
